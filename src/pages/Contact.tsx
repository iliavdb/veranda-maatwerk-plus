    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <Card className="border-2">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2">{t('Adres', 'Address')}</h3>
            ...
            <Card className="border-2">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2">{t('Telefoon', 'Phone')}</h3>
                    <a
                      href="tel:+31610576944"
                      className="text-accent hover:underline block text-lg"
                    >
                      06 10 57 69 44
                    </a>
          ...
          <Card className="border-2">
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold mb-6">{t('Stuur ons een bericht', 'Send us a message')}</h2>
